...
class RetailStoreDetection():
    def __init__(self, input_image) -> None:
        self.input_data = input_image
        self.model = None
        self.labels = None
        logger.info("Initating  Retail store items Detection for the input images")
    ...
    def load_model(self,model_path):
        try:
            ...
            logger.error("Error in loading  Retail store items Model")
    ...
    def load_labels(self,model_file):
        try:
            ...
            logger.error("Error in loading  Retail store items model labels")
    ...
    def draw_annotations_on_image(self, image_path, inference_data):
        ...
        try:
            ...
            color_scheme = {"object":(184, 48, 48),'label':(255,255,255)}
            counts = {"object":0}
    ...
    def run_detection(self):
        ...
        try:
            ...
            self.model = self.load_model(model_path=f"{os.getcwd()}{os.sep}models{os.sep}retail_store_item_detection_model.pt")
            ...
            logger.error("Error in run_detection  Retail store items()")